...
int main(int argc, char **argv) {
    ...
    int resolution = (argc > 2) ? atoi(argv[2]) : 300;
    ...
    int x_start = (argc > 4) ? atoi(argv[4]) : 0;
    int y_start = (argc > 5) ? atoi(argv[5]) : 0;
    int width = (argc > 6 && atoi(argv[6]) > 0) ? atoi(argv[6]) : max_width;
    int height = (argc > 7 && atoi(argv[7]) > 0) ? atoi(argv[7]) : max_height;
