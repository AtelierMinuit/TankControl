...
Nota de actualización: las ejecuciones 131/131, 133/133 y 134/134 son históricas; la suite vigente registrada en esta pasada es **139/139 PASS**.
...
Nota de consistencia: las cifras 134/134 y la build `061000` citadas en el párrafo histórico anterior no representan el estado vigente; la ejecución actual es **139/139 PASS** sobre `research/builds/audit-clean/20260904-065355`.
...
Corrección semántica del filtro: los comentarios de `rastertopcl3gui.c` ahora describen atenuación raster nominal y no afirman volumen físico de tinta ni control exclusivo de inyectores. La build `research/builds/audit-clean/20260904-065851` compiló correctamente; la suite actual mantiene **139/139 PASS**.
