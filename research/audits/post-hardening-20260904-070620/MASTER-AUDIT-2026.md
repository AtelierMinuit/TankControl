...
El decoder offline pasó 9/9 pruebas y Mode10 es el camino activo observado; Mode9 no debe documentarse como activo. La revisión de reproducibilidad detectó que los streams binarios del corpus diferencial descrito en `docs/DIFFERENTIAL-CORPUS.md` no están actualmente en el árbol, por lo que sus hashes y comparaciones se conservan como evidencia histórica hasta regenerar los artefactos.
