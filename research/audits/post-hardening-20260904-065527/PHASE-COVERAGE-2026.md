...
| 1 | Backend CUPS | build estricta y `clang --analyze`; consistencia 06:53 | PARCIAL |
...
| 22 | PKG | expansión, payload y rutas auditados; AppleDouble detectado y rechazado | PARCIAL |
| 23 | Root temporal | expansión sin instalación en `/`; instalador manual con `--dry-run` | PARCIAL |
| 24 | Uninstall | `--dry-run` verificado; instalación real ausente; preservación de cola/app ajenas | PARCIAL |
| 25 | Test matrix | 137/137 offline; hardware incompleto | PARCIAL |
...
| 28 | Seguridad | hardening, ShellCheck y análisis estático; revisión dinámica parcial | PARCIAL |
