...
La fuente HPLIP contiene 178 `UIConstraints`; el PPD propio contiene 0. Esto es un riesgo de compatibilidad: eliminar restricciones puede presentar combinaciones que el driver de referencia bloquea. Las opciones desbloqueadas permanecen experimentales hasta contar con justificación o prueba física.
