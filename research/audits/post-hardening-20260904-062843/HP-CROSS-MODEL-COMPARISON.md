...
Hallazgo de riesgo: el PPD HPLIP contiene 178 líneas `UIConstraints` y el PPD propio no contiene ninguna. La eliminación de esas restricciones puede exponer combinaciones de papel/tamaño que HPLIP bloquea para el modelo. Hasta validación física o justificación específica, las opciones “desbloqueadas” deben clasificarse como experimentales y no como compatibilidad ampliada.
