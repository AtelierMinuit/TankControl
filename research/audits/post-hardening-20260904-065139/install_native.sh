...
if [ "${1:-}" != "--confirm" ]; then
    echo "Este instalador modifica /Library y CUPS. Revisalo y ejecutalo manualmente con --confirm." >&2
    echo "Para una instalacion auditada, usa el .pkg versionado de research/builds/." >&2
    exit 2
fi
