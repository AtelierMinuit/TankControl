...
Build C limpia reproducida el 2026-09-04 06:34: `research/builds/audit-clean/20260904-063443`. Los cuatro ejecutables (`rastertopcl3gui`, `smarttank`, `hp_scan`, `hp-smart-tank-tool`) son arm64 y compilaron con código 0. La compilación de desarrollo de los componentes que usan USB enlaza contra Homebrew; el paquete distribuido usa la copia vendorizada documentada en la auditoría de dependencias. La suite contra esta build terminó 134/134 y el análisis estático por fuente no emitió diagnósticos.
