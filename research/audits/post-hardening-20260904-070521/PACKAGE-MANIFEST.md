...
Último paquete generado antes de endurecer el auditor (ahora **INVALIDADO**):

`research/builds/HP_Smart_Tank_500_Native_Apple_Silicon-20260904-063837.pkg`

SHA-256: `1684f96e99ee176cad92323e3bee31eaf7b090f7f0b200e67d4691bc8621f293`

El auditor actualizado detectó entradas AppleDouble `._*` en `pkgutil --payload-files`, aunque no se materialicen como archivos normales al expandir el payload. Por tanto este paquete no es apto para distribución. El empaquetador ahora limpia y verifica atributos extendidos antes de `pkgbuild`, y `tools/audit_package.sh` rechaza cualquier BOM con AppleDouble. La regeneración 06:40 quedó detenida porque `com.apple.provenance` reaparece en el staging de este host; no se instaló ningún paquete.
