...
OWNED_FILES=(
    ...
    "/usr/local/share/hp-smart-tank/hp_airprint_daemon.sh"
    "/usr/local/share/hp-smart-tank/hp_ipp_submit.sh"
    "/usr/local/share/hp-smart-tank/hp-smart-tank-500-airprint.conf"
